...
<body class="gray-bg">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>
									...
									<input type="checkbox" name="sHobby" value="排球">排球
								</td>
							</tr>
							<tr>
								<td>学生生日：</td>
								<td>
									<input placeholder="请选择时间" id="sBirth" name="sBirth" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							<tr>
								<td>专业：</td>
	...
	function initEditUser(getSelection){
		...
		var sHobbys = getSelection.sHobby.spilt(",");
		for (var i = 0; i < sHobbys.length; i++) {
			$("input[value='"+sHobbys[i]+"']").prop("checked",true);
		}
	}
