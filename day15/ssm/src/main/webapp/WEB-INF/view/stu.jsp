...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="name" class="" id="txt_search_name" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">年级</span>
					<select class="" name="grade" id = "txt_search_grade">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="begin" class="" id="txt_search_begin" >
			      <input type="date" name="end" class="" id="txt_search_end" >
				</div>
			  </div>
	...
	<!-- tc和修改对话框 -->
	<div class="modal fade" id="modal_user_tc" role="dialog" aria-labelledby="modal_user_tc" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_tc" method="post" action="reserveTc.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>老师姓名：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_tc">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
								<form id="form_import" method="post" action="studentImport.htm" enctype="multipart/form-data">
	...
	<!--导出对话框 -->
	<div class="modal fade" id="modal_user_down" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	...
	$(function () {
	    ...
	    var validator = $("#form_tc").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_tc").click(function(){
	    		$("#form_tc").resetForm();
	    		$('#modal_user_tc').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_tc').modal('show');
	        });
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	res.data.forEach(function(vo) {
							xary.push(vo.num);
							//yary.push(vo.cname);
							yary.push({value:vo.num,name:vo.cname});
